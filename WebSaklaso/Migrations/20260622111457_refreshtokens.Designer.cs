...
namespace WebSaklaso.Migrations
{
    ...
    [Migration("20260622111457_refreshtokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLoginDate = new DateTime(2026, 6, 17, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            LastLoginDate = new DateTime(2026, 6, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            LastLoginDate = new DateTime(2026, 6, 22, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            LastLoginDate = new DateTime(2026, 6, 12, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            ...
                            LastLoginDate = new DateTime(2026, 6, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            PhoneNumber = "+1-555-0105"
                        });
                });

            modelBuilder.Entity("WebSaklaso.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Discount = 10m,
                            OrderAmount = 199.97m,
                            OrderDate = new DateTime(2026, 6, 18, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Delivered"
                        },
                        new
                        {
                            ...
                            Discount = 15m,
                            OrderAmount = 369.96m,
                            OrderDate = new DateTime(2026, 6, 21, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Processing"
                        },
                        new
                        {
                            ...
                            Discount = 5m,
                            OrderAmount = 249.97m,
                            OrderDate = new DateTime(2026, 6, 22, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Pending"
                        },
                        new
                        {
                            ...
                            Discount = 0m,
                            OrderAmount = 129.98m,
                            OrderDate = new DateTime(2026, 6, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Delivered"
                        },
                        new
                        {
                            ...
                            Discount = 20m,
                            OrderAmount = 389.97m,
                            OrderDate = new DateTime(2026, 6, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Shipped"
                        },
                        new
                        {
                            ...
                            Discount = 8m,
                            OrderAmount = 149.98m,
                            OrderDate = new DateTime(2026, 6, 16, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = "Delivered"
                        });
                });

            modelBuilder.Entity("WebSaklaso.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebSaklaso.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebSaklaso.Models.Auth.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebSaklaso.Models.Auth.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Order", b =>
                {
                    b.HasOne("WebSaklaso.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("WebSaklaso.Entities.OrderItem", b =>
                {
                    b.HasOne("WebSaklaso.Entities.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebSaklaso.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("WebSaklaso.Entities.Product", b =>
                {
                    b.HasOne("WebSaklaso.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebSaklaso.Entities.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebSaklaso.Entities.RefreshToken", b =>
                {
                    b.HasOne("WebSaklaso.Models.Auth.AppUser", "User")
